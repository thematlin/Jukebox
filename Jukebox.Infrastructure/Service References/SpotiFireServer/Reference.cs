...
namespace Jukebox.Infrastructure.SpotiFireServer {
    ...
    public interface Spotify {
        ...
        void AddTrackFromSearchToPlaylist(System.Guid playlistId, string query, int trackPosition);
    }
    ...
    public partial class SpotifyClient : System.ServiceModel.ClientBase<Jukebox.Infrastructure.SpotiFireServer.Spotify>, Jukebox.Infrastructure.SpotiFireServer.Spotify {
        ...
        public void AddTrackFromSearchToPlaylist(System.Guid playlistId, string query, int trackPosition) {
            base.Channel.AddTrackFromSearchToPlaylist(playlistId, query, trackPosition);
        }
    }
}
